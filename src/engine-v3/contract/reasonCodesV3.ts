export const SMARTSTAY_REASON_CODES_V3 = [
  ...
  "decision:abstained",
  "decision:decisionally-equivalent",
  "decision:no-feasible-solution",
  "decision:recommended",
  "eligibility:solution-incomplete",
  "eligibility:solution-infeasible",
  "eligibility:source-ineligible",
  "eligibility:maximum-distance-exceeded",
  "eligibility:maximum-distance-unverified",
  "eligibility:mandatory-requirement-exceeded",
  "eligibility:mandatory-requirement-unverified",
  ...
  "evaluation:critical-regression-blocked",
  ...
  "promotion:critical-regression-blocked",
  "promotion:decision-diff-recorded",
  "promotion:human-gate-required",
  "promotion:kill-switch-activated",
  ...
  "promotion:reason-diff-recorded",
  "promotion:rollback-required",
  "promotion:v2-public-authority",
  "promotion:v3-shadow-only",
  ...
  "robustness:decisionally-equivalent",
  "robustness:near-tie",
