export const SMARTSTAY_REASON_CODES_V3 = [
  ...
  "explanation:alternative-available",
  ...
  "explanation:primary-reason-available",
  ...
  "explanation:switch-condition-available",
  "explanation:switch-condition-unavailable",
  "explanation:trade-off-available",
  "explanation:trade-off-unavailable",
  "explanation:uncertainty-available",
