...
test("V3-17T1 manifest hash and authorization literal are deterministic and bound", () => {
  ...
  assert.equal(STAYOPTI_SERPAPI_REQUIRED_AUTHORIZATION_LITERAL_V3, `AUTHORIZE_V3_17T2_CANARY_${STAYOPTI_SERPAPI_PILOT_MANIFEST_HASH_V3}_RUNNER_${STAYOPTI_SERPAPI_PILOT_RUNNER_BUNDLE_HASH_V3}_RETENTION_V2_MAX2`);
