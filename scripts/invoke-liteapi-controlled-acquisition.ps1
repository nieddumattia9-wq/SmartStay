...
Invoke-StayOptiProtectedProfile -Mode $Mode -NodePath $AcquisitionNode -NodeArguments $AcquisitionArgs -ReadyStatus 'READY_FOR_EXPLICIT_ACQUISITION_AUTHORIZATION' -ErrorPrefix 'LITEAPI_ACQUISITION' -SafetyNotice 'Massimo 17 richieste; fino a 5 creazioni prebook. Nessuna prenotazione o esecuzione motore.'
