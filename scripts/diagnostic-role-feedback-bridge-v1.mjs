...
export function prepareDiagnosticRoleFeedback({packet,events,codeHash,reviewArchiveSha256,feedback,feedbackSha256,originalManifestSha256,budgetMinorUnits,currency}){
  ...
  return {diagnosticInput:input,diagnosticInputFingerprint:inputHash,feedbackRecord,reviewedObservations:structuredClone(state.alternatives),missingness,bindings:expected,prerequisites:{
    ...
    verifiedSyntheticCapabilities:{proof:'diagnosticCapabilityProbeV3 / D-0042',ratingScaleUnknown:'OMIT_UNNORMALIZABLE_RATING; ENGINE_CAN_COMPUTE_WITH_LOWER_EVIDENCE',completeTotalUnknown:'DISPLAY_PRICE_CAN_BE_SCORED; INCOMPLETE_SELECTED_SOLUTION_BLOCKS_INDEPENDENT_OUTPUT',distance:'maximumDistanceKm_IS_NOT_A_SOFT_PREFERENCE',realCaseExecutionInferred:false},
